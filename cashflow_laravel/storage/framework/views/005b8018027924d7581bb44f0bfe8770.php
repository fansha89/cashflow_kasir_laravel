                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="50"
                                        src="<?php echo e(asset('img/avatar/avatar-1.png')); ?>" alt="avatar">
                                    <div class="media-body">
                                        <div class="text-primary float-right">Now</div>
                                        <div class="media-title">Fadlurrahman Abror Gaming</div>
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="50"
                                        src="<?php echo e(asset('img/avatar/avatar-2.png')); ?>" alt="avatar">
                                    <div class="media-body">
                                        <div class="float-right">12m</div>
                                        <div class="media-title">Delon Sihite</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="50"
                                        src="<?php echo e(asset('img/avatar/avatar-3.png')); ?>" alt="avatar">
                                    <div class="media-body">
                                        <div class="float-right">17m</div>
                                        <div class="media-title">Fakhriza Fansha</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="50"
                                        src="<?php echo e(asset('img/avatar/avatar-4.png')); ?>" alt="avatar">
                                    <div class="media-body">
                                        <div class="float-right">21m</div>
                                        <div class="media-title">Restu Rustamaji</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                            ...
                            <div class="row pb-2">
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="<?php echo e(asset('img/avatar/avatar-5.png')); ?>"
                                            class="img-fluid" data-toggle="tooltip" title="Restu Rustamaji">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="<?php echo e(asset('img/avatar/avatar-4.png')); ?>"
                                            class="img-fluid" data-toggle="tooltip" title="Sandy Boangmanalu">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="<?php echo e(asset('img/avatar/avatar-1.png')); ?>"
                                            class="img-fluid" data-toggle="tooltip" title="Abror Gaming">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="<?php echo e(asset('img/avatar/avatar-2.png')); ?>"
                                            class="img-fluid" data-toggle="tooltip" title="Fakhriza Fansha">
                                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i
                                                class="fas fa-cog"></i></div>
                                    </div>
                                </div>
                                ...
                                <div class="summary-item">
                                    ...
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="<?php echo e(asset('img/products/product-1-50.png')); ?>" alt="product">
                                            </a>
                                            <div class="media-body">
                                                <div class="media-right">$405</div>
                                                <div class="media-title"><a href="#">PlayStation 9</a></div>
                                                <div class="text-muted text-small">by <a href="#">Frans Sihite</a>
                                        ...
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="<?php echo e(asset('img/products/product-2-50.png')); ?>" alt="product">
                                            </a>
                                            <div class="media-body">
                                                <div class="media-right">$499</div>
                                                <div class="media-title"><a href="#">RocketZ</a></div>
                                                <div class="text-muted text-small">by <a href="#">Abror Gaming</a>
                                                    <div class="bullet"></div> Sunday
                                                </div>
                                            </div>
                                        </li>
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="<?php echo e(asset('img/products/product-3-50.png')); ?>" alt="product">
                                            </a>
                                            <div class="media-body">
                                                <div class="media-right">$149</div>
                                                <div class="media-title"><a href="#">Xiaomay Readme 4.0</a></div>
                                                <div class="text-muted text-small">by <a href="#">Sandy Boangmanalu</a>
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Restu Rustamaji <div class="bullet"></div>
                                ...
                                <li class="media">
                                    ...
                                    <img class="rounded-circle mr-3" width="50"
                                        src="<?php echo e(asset('img/avatar/avatar-5.png')); ?>" alt="avatar">
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Delon Sihite <div class="bullet"></div> 4 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Delon Sihite <div class="bullet"></div> 8 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Fadlurrahman Abror Gaming <div class="bullet"></div> 21
                                            Min</div>
                                    </div>
                                </li>
                            </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600"><img
                                                        src="<?php echo e(asset('img/avatar/avatar-1.png')); ?>" alt="avatar"
                                                        width="30" class="rounded-circle mr-1"> Andarika Restu</a>
                                            </td>
                                            <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cashflow_laravel\cashflow_laravel\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>